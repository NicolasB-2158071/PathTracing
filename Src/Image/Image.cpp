...
Image::Image(unsigned short width, unsigned short height) : m_width{ width }, m_height{ height }, m_pixels(m_width * m_height * 3, 0.0f) {}
...
void Image::Save(const std::string& path, std::vector<float>* pixels) {
    if (pixels != nullptr) {
